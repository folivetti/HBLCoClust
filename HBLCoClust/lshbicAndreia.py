...
if __name__ == "__main__":
    ...
    nhashes,nkeys = 100,5  # lsh parameters
    min_rows, min_cols = 5,15 # row, col thresholds
    thr = 0.2            # probability threshold
    sparse = 0.7            # sparseness rate
    main(dataset, (nhashes,nkeys), (min_rows,min_cols), thr, sparse)
    '''
    dataset = 'AG'    # dataset name
    nhashes,nkeys = 975,4  # lsh parameters
    min_rows, min_cols = 2,4 # row, col thresholds
